...
>>> 4-3 (예시 : C:\oracle\instantclient-basic-windows.x64-19.23.0.0.0dbru)
>>> 4-4 [필수] C:\oracle\instantclient-basic-windows.x64-19.23.0.0.0dbru\instantclient_19_23 경로가 존재해야됨
+ 이후 재시작
